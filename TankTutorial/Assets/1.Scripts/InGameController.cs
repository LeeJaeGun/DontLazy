...
public class InGameController : MonoBehaviour
{
    ...
    public EnemyTankManager[] m_EnemyTanks;         
    ...
    private void SpawnAllEnemyTanks()
    {
        ...
        for (int i = 0; i < m_EnemyTanks.Length; i++)
        {
            ...
            m_EnemyTanks[i].m_Instance =
                Instantiate(m_EnemyTankPrefab, m_EnemyTanks[i].m_SpawnPoint.position, m_EnemyTanks[i].m_SpawnPoint.rotation) as GameObject;
    ...
    private void SetCameraTargets()
    {
        ...
        else
        {
            ...
            for (int i = 0; i < targets.Length-1; i++)
            {
                ...
                targets[index] = m_EnemyTanks[i].m_Instance.transform;
                index++;
            }
